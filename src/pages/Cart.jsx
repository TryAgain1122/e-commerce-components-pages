        ...
        <Navbar/>
            <div className='p-5'>
                ...
                <div className='flex items-center justify-between mt-4 mobile:flex-col'>
                    ...
                    <div className='flex underline text-lg hover:cursor-pointer mobile:mb-3'>
                ...
                <div className='flex mt-7 mobile:flex-col'>
                    <div className='flex flex-col flex-1'>
                        <div className='flex w-[100%] h-auto items-center mobile:flex-col'>
                            ...
                            <div className='flex flex-col justify-center items-center flex-auto mobile:mt-3'><Counter/>
